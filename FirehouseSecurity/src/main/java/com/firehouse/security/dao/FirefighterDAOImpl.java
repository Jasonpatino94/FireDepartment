...
//		List<Certification> certs = currentSession.get(Firefighter.class, id).getfCerts();
		System.out.println("getting firefighter");
		Firefighter ff = currentSession.get(Firefighter.class, id);
		System.out.println("got firefighter" + ff.getfFirstName());
		List<Certification> certs = ff.getfCerts();
		System.out.println("got the certs!");
		return certs;
	}
